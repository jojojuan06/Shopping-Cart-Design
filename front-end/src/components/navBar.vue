<template>
    <div class="flex  justify-center md:justify-between   w-full items-center p-1  bg-[#171c1d]">
      <div class="flex">
        ...
        <div class="pt-2 relative mx-auto text-gray-600 w-full  max-w-[200px] md:max-w-full">
            ...
            <button type="submit" class="absolute  bottom-3 mt-5 mr-4 left-[10rem] md:left-40">
              <svg class="text-gray-600 h-4 w-4 md:w-full fill-current" xmlns="http://www.w3.org/2000/svg"
